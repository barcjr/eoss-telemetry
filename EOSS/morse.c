...
rom const unsigned char MorseCodeLib[14][DATA_BYTES_PER_LINE + 1] =
{
	...
	{0x17, 0x77, 0x77, 0x47, 0x20},  // 'N0HF'
	{0x15, 0x75, 0x01, 0x00, 0x14},  // 'N0HF'
};
...
void txCallsign()
{
	unsigned char morse[] = {12, 13, TERMINATOR};
